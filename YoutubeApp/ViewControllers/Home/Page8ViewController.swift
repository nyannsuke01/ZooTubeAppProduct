...
class Page8ViewController: CommonPageViewController, IndicatorInfoProvider {
...
extension Page8ViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    //アイテムが選択された時の動作
