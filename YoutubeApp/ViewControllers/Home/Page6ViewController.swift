...
class Page6ViewController: CommonPageViewController, IndicatorInfoProvider {
...
extension Page6ViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    //アイテムが選択された時の動作
