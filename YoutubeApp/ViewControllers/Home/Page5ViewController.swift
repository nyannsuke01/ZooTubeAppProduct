...
class Page5ViewController: CommonPageViewController, IndicatorInfoProvider {
...
extension Page5ViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    //アイテムが選択された時の動作
